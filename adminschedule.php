...
<br><br>
<div class="butt">
    <a  style="background-color: rgb(74, 74, 165)" ; onClick="location.href='../screens/formschhhh.php'"  >INSERT</a>
    <button style="background-color: rgb(112, 209, 233);">UPDATE</button>
    <button style="background-color: rgb(231, 15, 15);">DELETE</button>
</div>
