<!--Jaria batool
    ...
    BCSC 5th
    G9_CS_2
    ADMIN BUS REQUISITION WEB PAGE
-->

<!DOCTYPE html>
<html>
    <head>
        <title>Admin Bus requisition</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="column">
            <!--form-->
        <form id="req" method="post" action="form.php">
            <label for="Adest"> <b>Destination:</b> </label><br>
            <input type="text" id="Adest" name="d" onchange="validate()">
            <br>
            <label id="errorName" ></label>
            <label for="Abus"><b>Bus number</b></label><br>
            <input type="number" id="AbusNo"  name="b" maxlength=2 ><br>
            <label id="errorName" ></label>
            <label for="Atime"><b>Time</b></label><br>
            <input type="time" id="Atime"  name="t" ><br>
            <label for="Adate"> <b> Date:</b></label><br>
            <input type="date" id="Adate" name="dt" min="2023-01-01" max="2023-01-31" >
            <button id="Add" name="Add">  <b>Add</b> </button>
        </form>
        </div>
        <div class="column">
            <!--REQUISITION TO BE-->
