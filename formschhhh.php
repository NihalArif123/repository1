...
<body>
    ...
    <form action=" form1sch.php" method="post">
    <label for="busno" id="busno">BUS.NO:</label>
    <input type="number" id="num" name="busno"> <br>
    <label for="route" id="route">ROUTE:</label>
    <input type="text" id="route" name="route"> <br>
    <label for="date" id="date">DATE:</label>
    <input type="date" id="date" name="date"> <br>
    <label for="time" id="time">TIME:</label>
    <input type="time" id="tim" name="time"> <br>
